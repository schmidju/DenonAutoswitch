...
#    if   IRSND_OCx == IRSND_OC2                        // use OC2
        ...
        TCCR2 |= (1<<WGM21);                            // do not use the toggle function because we want to simulate without led
...
void irsnd_deinit(void) {
    IRSND_DDR &= ~(1<<IRSND_BIT);                                                // set IRSND_BIT to Input again
}
